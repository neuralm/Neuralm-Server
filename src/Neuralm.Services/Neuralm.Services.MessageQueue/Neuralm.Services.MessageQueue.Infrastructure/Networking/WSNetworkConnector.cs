...
namespace Neuralm.Services.MessageQueue.Infrastructure.Networking
{
    /// <summary>
    ...
    public class WSNetworkConnector : BaseNetworkConnector
    {
        ...
        public WSNetworkConnector(IMessageSerializer messageSerializer, IMessageProcessor messageProcessor, string host, int port) : base(messageSerializer, messageProcessor)
        {
            _host = host;
            _port = port;
        ...
        public WSNetworkConnector(IMessageSerializer messageSerializer, IMessageProcessor messageProcessor, TcpClient tcpClient) : base(messageSerializer, messageProcessor)
        {
