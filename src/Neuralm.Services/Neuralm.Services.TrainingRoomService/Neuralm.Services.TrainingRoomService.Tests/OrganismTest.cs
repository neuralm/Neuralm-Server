    ...
    public class OrganismTests
    {
        ...
        public class EqualsTests : OrganismTests
        {
            ...
            public void Initialize()
            {
                ...
                _fakeUser = new User();
                _organismFactory = new OrganismFactory();
                _trainingRoom = new TrainingRoom(trainingRoomId, _fakeUser, _roomName, new TrainingRoomSettings(trainingRoomId, 0, 3, 1, 1, 1, 0.4, 3, 0.05, 0.03, 0.75, 0.001, 1, 0.8, 0.1, 0.5, 0.25, 0, 15, 5), _organismFactory);
            }
